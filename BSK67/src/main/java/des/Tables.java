...
class Tables {
    ...
    private static int[] leftShiftOrder = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};

    static int[] getpTable() {
        return pTable;
    }

    static int[] geteTable() {
        return eTable;
    }

    static ArrayList<int[][]> getSBoxes() {
