...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        CA cos2 = new CA();
        System.out.println(cos2.encrypt(Polynomial.read("x^5+x^2+x+1"), Lists.newArrayList(0, 1, 1, 1, 0), Lists.newArrayList(1, 0, 0, 1, 1, 1)));
        System.out.println(cos2.decipher(Polynomial.read("x^5+x^2+x+1"), Lists.newArrayList(0, 1, 1, 1, 0), Lists.newArrayList(0, 1, 0, 1, 0, 0)));
